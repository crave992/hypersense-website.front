...
@Component({
  selector: 'app-ctc-wallet',
  templateUrl: './ctc-wallet.component.html'
})
export class CtcWalletComponent implements OnInit {
  section1 = true;
  section2 = false;
  section3 = false;
  imageSection = 1;
  ...
  slug: string = 'CTC-Wallet-transport-flutter-mobile-app';
