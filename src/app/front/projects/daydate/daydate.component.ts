...
@Component({
  selector: 'app-daydate',
  templateUrl: './daydate.component.html',
  styleUrls: ['./daydate.component.scss']
})
export class DaydateComponent implements OnInit {
  ...
  imageSizeList(
      name: string, path: string = 'images', extensions: string[] = ['webp', 'png']
  ): {media: string; type: string; srcSet: string}[]
  {
    const list = [];
